...
Shizuku can help normal apps uses sysStarting with root...


Can't open root shell, try again...

Still not :(tem APIs directly with adb/root privileges with a Java process started with app_process.
